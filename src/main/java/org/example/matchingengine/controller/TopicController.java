...
public class TopicController {
    ...
    @SendTo("/topic/stats")
    public String broadcastStats(String statsMessage) {
        System.out.println("Received stats message: " + statsMessage);
        notificationService.broadcastMessage("/topic/stats", statsMessage);
